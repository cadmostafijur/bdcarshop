...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.fhxx6je.mongodb.net/?retryWrites=true&w=majority`;
...
app.get('/', (req, res) => {
    res.send('Bdcarsshop server is running')
})

app.listen((port), () => {
    console.log(`Bdcarsshop server is running : ${port}`)
})
